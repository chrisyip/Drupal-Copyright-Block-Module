...
2. The name of the copyright holder - This defaults to the name of your site if left blank. Add any copyright holder name to override the default.
...
Module maintainer:
* Mark Ewers - http://drupal.org/user/80648